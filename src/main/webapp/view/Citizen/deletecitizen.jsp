...
<head>
	<meta charset="UTF-8">
	<title>Удаление физического лица</title>
...
<body>
	...
	<div class="col-sm-6">
	<input type="text" class="form-control" name="document_id" readonly
	value="${citizensDelete[0].getDocumentId()}" />
	</div>
	</div>
	...
	<div class="col-sm-6">
	<input type="text" class="form-control" name="person_id" readonly
	value="${citizensDelete[0].getPersonId()}" />
	</div>
	</div>
	...
	value="${citizensDelete[0].getFirstName()}" />
	</div>
	</div>
	...
	<div class="col-sm-6">
	<input type="text" class="form-control" name="second_name" readonly
	value="${citizensDelete[0].getSecondName()}" />
	</div>
	</div>
	...
	value="${citizensDelete[0].getLastName()}" />
	</div>
	</div>
	...
	value="${citizensDelete[0].getNumber()}" />
	</div>
	</div>
	<button type="submit" class="btn btn-primary">Удалить</button>
	<a href='<c:url value="/citizens" />' role="button"
